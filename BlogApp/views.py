...
#send_mail('Hello', 'Very imp msg....','Sheelumtejasri123@gmail.com',['chilakesikalyani2001@gmail.com','anithaaradesi@gmail.com'])
from django.core.mail import send_mail
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'Sheelumtejasri123@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
        form=EmailSendForm()
